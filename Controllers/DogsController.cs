...
namespace kinological_club.Controllers
{
    public class DogsController : Controller
    {
        ...
        {
            using (var connection = new NpgsqlConnection("Server=localhost;Database=dogsclub;Port=5432;User Id=postgres;Password="")) // Замените "your_connection_string" на свою строку подключения
            {
                connection.Open();
